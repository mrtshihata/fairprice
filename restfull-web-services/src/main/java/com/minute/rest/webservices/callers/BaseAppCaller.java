...
public class BaseAppCaller extends LoginCaller{
	private final static Logger LOGGER = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME);

	private static BaseAppCaller PropertiesCache;
	private final static Properties configProp = new Properties();
	private static String Propertyfilename = "appConfig.properties";

	public BaseAppCaller setPropertyfilename(String Propertyfilename) {
	...
	public static class ResourceLoader {
		private static final BaseAppCaller INSTANCE = new BaseAppCaller();
	}

	public static BaseAppCaller getInstance() {
	...
	public String get_appUri() {
		return PropertiesCache.getInstance().getProperty("appUri");
	}
