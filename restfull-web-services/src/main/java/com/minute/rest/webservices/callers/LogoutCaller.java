...
public class LogoutCaller {
	private final static Logger LOGGER = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME);

	private static LogoutCaller PropertiesCache;
	private final static Properties configProp = new Properties();
	private static String Propertyfilename = "logout.properties";

	public LogoutCaller setPropertyfilename(String Propertyfilename) {
	...
	public static class ResourceLoader {
		private static final LogoutCaller INSTANCE = new LogoutCaller();
	}

	public static LogoutCaller getInstance() {
	...
	public static String logout() {
		return PropertiesCache.getInstance().getProperty("logout_id");
	}
