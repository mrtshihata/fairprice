...
public class AuditServiceCaller {
	private final static Logger LOGGER = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME);

	private static AuditServiceCaller PropertiesCache;
	private final static Properties configProp = new Properties();
	private static String Propertyfilename = "auditService.properties";

	public AuditServiceCaller setPropertyfilename(String Propertyfilename) {
	...
	public static class ResourceLoader {
		private static final AuditServiceCaller INSTANCE = new AuditServiceCaller();
	}

	public static AuditServiceCaller getInstance() {
	...
	public String getQueueName() {
		return PropertiesCache.getInstance().getProperty("queueName");
	}
	...
	public String getRequestHeaderKey1() {
		return PropertiesCache.getInstance().getProperty("requestHeaderKey1");
	}

	public String getRequestHeaderValue1() {
		return PropertiesCache.getInstance().getProperty("requestHeaderValue1");
	}
	
	public String getRequestBody() {
		return PropertiesCache.getInstance().getProperty("requestBody");
	}	
	
	public String getRequestEndpoint() {
		return PropertiesCache.getInstance().getProperty("requestEndpoint");
	}	
}
